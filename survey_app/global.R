...
al <- list(
  ...
  c("Современный", "Классический", "Неблагоустроенный / устаревший"), # Office
  c("Через 1 год", "Через 3 года", "Через 5 лет"), # promotion criterion
...
labels_rus[[5]] <- c("Современный", "Классический", "Неблагоустроенный / устаревший") # Office
labels_rus[[6]] <- c("Через 1 год", "Через 3 года", "Через 5 лет") # promotion criterion
