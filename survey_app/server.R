...
rowCallback <- c(
  ...
  hints = {
    ...
    "Формальная":"Строгая иерархия, отстраненное и не эмапатичное начальство, общение на “Вы” внутри коллектива, активный мониторинг сотрудников, строгий дресс-код",
    "Полуформальная":"Комфортная рабочая атмосфера, одновременно предполагающая определенные границы, связанные со статусом сотрудника; нейтральное начальство; классический дресс-код без строгих ограничений",
    "Неформальная":"Низкая иерархия и развитые горизонтальные связи, вдохновляющее начальство, индивидуальный подход к каждому сотруднику, общение на “ты” внутри коллектива, минимальный мониторинг сотрудников или его полное отсутствие, требования о дресс-коде отсутствуют",
