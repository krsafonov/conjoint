...
rowCallback <- c(
  ...
  hints = {
    ...
    "Плохо обустроенный":"Классический ремонт в хорошем состоянии, менее удобная планировка рабочего пространства, столовая для сотрудников",
    "Средне обустроенный":"Ремонт не обновлялся много лет, душные замкнутые помещения, бедная инфраструктура как внутри офиса, так и вокруг него",
